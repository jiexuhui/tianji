<template>
  <div class="app-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column align="center"  min-width="150" label="左侧选项" prop = "answer1">
      </el-table-column>
      <el-table-column align="center" label="右侧选项" width="150px" prop = "answer2">
      </el-table-column>
      <el-table-column align="center"  min-width="150" label="正确答案" prop = "right">
        <template slot-scope="scope">
          <span v-if="scope.row.right == 0">未结束</span>
          <span v-if="scope.row.right == 1">{{scope.row.answer1}}</span>
          <span v-if="scope.row.right == 2">{{scope.row.answer2}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center"  min-width="150" label="时间" prop = "date">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="100px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="左侧选项" prop="answer1" >
          <el-input v-model="temp.answer1"></el-input>
        </el-form-item>
        <el-form-item label="右侧选项" prop="answer2" >
          <el-input v-model="temp.answer2"></el-input>
        </el-form-item>
        <el-form-item label="正确答案" prop="right">
          <el-select class="filter-item" v-model="temp.right" placeholder="正确答案">
            <el-option v-for="item in rightOptions" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
...
<script>
import { list, add, edit, del, upload } from "@/api/guessing";
