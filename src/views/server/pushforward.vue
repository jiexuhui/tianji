<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" min-width="150" label="结算状态">
        <template slot-scope="scope">
          <el-tag :type="scope.row.status | statusFilter" v-if="scope.row.status === 1">申请中</el-tag>
          <el-tag :type="scope.row.status | statusFilter" v-if="scope.row.status === 2">已结算</el-tag>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          ...
          >通过</el-button>
          <el-tag v-if="scope.row.status == 2">已结算</el-tag>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { list, pass } from "@/api/pushforward";
